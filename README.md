...
-Slow transaction speed at E-Gate and Out-Gate

-Repetitive operational and compliance-related issues

-Process dependency on external actors (truckers, clearing agents, customs)

-Lack of early detection of issues that surfaced late in the process
...
-Pre-Yard2Truck delays

-Yard2Truck → Weighment

-Weighment → Documentation (Form A)

-Documentation → Gate-Out
...
-Definition: Total time from Gate-In to Gate-Out

-Purpose: Primary performance metric to assess process efficiency

-Baseline: ~126 minutes (actual)

-Target: ~85 minutes (lean benchmark)
...
-Measure: Average transaction duration per truck

-Lean Goal: Reduce processing time and increase trucks/hour per booth
...
-Baseline: ~30 minutes average

-Target: ~10 minutes acceptable waiting

-Finding: Waiting time was double the ideal proportion of TTT
...
-Weighment → Form A Print

-Form A Print → Gate-Out

-Metrics Used: Median, mean, quartiles
...
-Examples: Seal disparity, system errors, documentation issues

-Lean Tool: Pareto principle (80/20)
...
-Insight: Some low-frequency issues caused extreme delays
...
-Purpose: Measure capacity utilization
...
-Insight: Behavioral incentives significantly impacted KPIs
...
-Segmentation by frequency × severity

-Median vs mean analysis to handle outliers
...
-Increased gate throughput and equipment utilization

-Lower congestion and operational delays

-Improved predictability and planning

-Strong foundation for continuous improvement and KPI governance
